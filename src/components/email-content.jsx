  ...
  return (
    <section id="sendEmail" className="bg-slate-100 text-primary p-4">
      ...
      <form className="flex flex-col gap-2 p-4" onSubmit={sendEmail}>
        <input name="name" placeholder="Name" className="p-1 border"/>
        <input name="emailid" placeholder="Email ID" className="p-1 border"/>
        <input name="subject" placeholder="Subject" className="p-1 border"/>
        <textarea name="message" placeholder="Message" className="p-1 h-32 border"/>
